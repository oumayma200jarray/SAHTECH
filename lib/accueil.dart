...
import 'package:sahtek/widgets/content_card.dart';
import 'package:sahtek/widgets/buttons.dart';
import 'package:sahtek/widgets/custom_bottom_nav_bar.dart';
...
class AccueilPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<List<ContentModel>> fetchVideosFromBackend() async {
      try {
        final List<dynamic> data = await ApiRequest.instance.get('/videos');
    ...
    Future<List<ContentModel>> fetchArticlesFromBackend() async {
      try {
        final List<dynamic> data = await ApiRequest.instance.get('/articles');
        return data.map((json) => ContentModel.fromJson(json)).toList();
      } catch (e) {
