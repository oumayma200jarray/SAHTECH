...
class AdminService {
  ...
  static Future<AdminStats> getStats() async {
    try {
      final data = await ApiRequest.instance.get('/admin/stats');
  ...
  static Future<List<SpecialistValidation>> getPendingValidations() async {
    try {
      final List<dynamic> data = await ApiRequest.instance.get('/admin/validations');
...
class ChatService {
  ...
  static Future<ChatConversation> getConversation() async {
    try {
      final data = await ApiRequest.instance.get('/messages');
...
class SpecialistDashboardService {
  ...
  static Future<SpecialistStats> getStats() async {
    try {
      final data = await ApiRequest.instance.get('/specialist/stats');
  ...
  static Future<List<SpecialistAppointment>> getTodaysAppointments() async {
    try {
      final List<dynamic> data = await ApiRequest.instance.get('/specialist/appointments/today');
