    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              Expanded(child: buttonIn('Modifier', onEdit ?? () {})),
                ...
                onPressed:
                    ...
                    () {
                      Provider.of<GlobalDataProvider>(
                        context,
                        listen: false,
                      ).removeAvailabilitySlot(slot.id);
                    },
  ...
  String _getDayLabel(int day) {
    switch (day) {
      ...
      case 2:
        return 'Mardi 15 Oct.';
      case 3:
        return 'Mercredi 16 Oct.';
      case 4:
        return 'Jeudi 17 Oct.';
      case 5:
        return 'Vendredi 18 Oct.';
      case 6:
        return 'Samedi 19 Oct.';
      case 7:
        return 'Dimanche 20 Oct.';
      default:
        return 'Inconnu';
    }
  }
